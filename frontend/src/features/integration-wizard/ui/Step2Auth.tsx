...
export function Step2Auth({ sourceType, credentials, isTesting, testResult, onCredentialChange, onTest }: Props) {
  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-3 pt-2">
        <Button variant="outline" size="sm" onClick={onTest} disabled={isTesting} className="cursor-pointer">
          {isTesting ? "確認中..." : "接続テスト"}
        </Button>
        {testResult === true && (
